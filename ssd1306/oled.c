...
//static uint8_t SSD1306_Buffer_all[SSD1306_LCDWIDTH * SSD1306_LCDHEIGHT / 8 + 1], *SSD1306_Buffer = SSD1306_Buffer_all + 1;
...
void oled_update(void)
{
	...
	for (uint16_t line = 0; line < 4; line++)
	{
		for (uint8_t x = 0; x < 127; x += 16)
		{
			...
			/* HAL_I2C_Master_Transmit_DMA (&hi2c1, 0x78, buffer, 17);
